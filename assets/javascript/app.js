...
$(document).ready(function() {
    ...
    var questions = [
        ...
        // ["How many moons have been discovered on Saturn?"],
    ...
    function generateQuestions() {
        ...
        createButton("Submit");
        // var submitButton  = $("<button>").attr("id", "submitButton");
        // submitButton.text("Submit");
        // submitButton.attr("class", "btn btn-info btn-lg btn-block text-dark shadow font-weight-bold");
    ...
    function results() {
        ...
        for (var i = 0; i < questions.length; i++) {
            ...
            // console.log(document.getElementsByName("radio0"));
            // if (questions[0].a === $("input[name=radio0]:checked").val()) {
            // correct++;
            // }
            // else {
            //     incorrect++;
        ...
        $("#timerDiv").append($("<h1>").text("Trivia Complete"));
        $("#timerDiv").append($("<p>").text("Correct Answers: " + correct));
        $("#timerDiv").append($("<p>").text("Correct Answers: " + incorrect));
